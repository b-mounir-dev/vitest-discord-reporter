...
describe('DiscordReporter', () => {
  ...
  it('calculates stats correctly', () => {
    ...
    const stats = (reporter as any).calculateStats(files);
  ...
  it('builds summary embed with mention on failure and duration', () => {
    ...
    const embeds = (reporter as any).buildEmbeds(files, 2500);
  ...
  it('includes failed and passed embeds with proper formatting', () => {
    ...
    const embeds = (reporter as any).buildEmbeds(files, 1000);
  ...
  it('limits failed tests embed to 10 and shows notice for more', () => {
    ...
    const failed = (reporter as any).getFailedTests(files);
    const failedEmbed = (reporter as any).buildFailedTestsEmbed(failed);
